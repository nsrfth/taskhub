// v1.24: lightweight inline SVG icon set. Lucide-style strokes (1.75 px,
// rounded caps). Same prop shape across all icons so callers can swap freely.
// Kept in one file to avoid bundle bloat from a full icon library — we only
// need ~13 glyphs.
